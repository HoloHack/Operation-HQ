...
assert(read("js/newtab.js").includes('"js/nexus.js"'), "Nexus is not packaged in the new-tab bootstrap");
...
assert(read("js/newtab.js").includes('"js/study-os.js"'), "Study OS is not packaged in the lazy feature registry");
...
assert(html.includes('id="bookmark-review-board"'), "Uncertain bookmarks lack an explicit correction surface");
