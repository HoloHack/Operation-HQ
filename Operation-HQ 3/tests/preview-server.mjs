...
http.createServer((request, response) => {
  ...
  if (relative === "newtab.html") {
    body = Buffer.from(body.toString().replace("<script src=\"js/early-diagnostics.js\"></script>", "<script src=\"tests/preview-shim.js\"></script>\n<script src=\"js/early-diagnostics.js\"></script>"));
  }
