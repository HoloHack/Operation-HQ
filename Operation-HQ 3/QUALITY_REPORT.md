# Operation HQ 2.7 — Apex Compositor Review
...
9. **Build identity, widgets and compositor:** confirm Settings → General → System Health reads `2.7.0 · Apex Compositor`; click every visible widget launcher, reorder compatible widgets, reload, and confirm order/visibility persist. Test Auto, Ultra, Balanced, Efficient and Off; confirm measured status appears, Off stops motion, and returning to Auto restarts without a page reload.
