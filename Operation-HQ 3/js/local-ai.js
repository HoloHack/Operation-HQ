...
//   done here.
// - ONE MODEL, NOT CONFIGURABLE YET: Llama-3.2-1B-Instruct, ~700MB–900MB
//   depending on quantization, chosen because it's the smallest
//   genuinely-usable instruction-tuned model in WebLLM's own prebuilt
//   config — appropriate for "always-on cheap reasoning" per the
//   roadmap's own framing, not for anything demanding.
...
const LocalAI = {
  MODEL_ID: "Llama-3.2-1B-Instruct-q4f16_1-MLC", // real model ID, verified against WebLLM's own prebuiltAppConfig, not guessed
  _engine: null,
  _loading: false,
  _bridgePromise: null,
  _generation: 0,
